              ...
              <div className="flex rounded-lg h-full p-8 flex-col">
                <div className="flex items-center mb-3">
                  ...
                  <h2 className="text-gray-100 text-lg title-font font-medium">
                    ...
                    <IoLogoJavascript className="inline ml-2 bg-blue-700" /> /{" "}
                    <TbBrandTypescript className="inline bg-blue-800" />
                  </h2>
                </div>
                <div className="flex-grow">
                  <div className="relative h-1 w-full bg-gray-100 rounded-xl">
            ...
            <div className="p-4 w-[100%] md:w-1/3">
              <div className="flex rounded-lg h-full p-8 flex-col">
                <div className="flex items-center mb-3">
                  ...
                  <h2 className="text-gray-100 text-lg title-font font-medium">
                    Tailwindcss{" "}
                    <RiTailwindCssLine className="inline ml-2 bg-blue-700" />
                  </h2>
                </div>
                <div className="flex-grow">
                  <div className="relative h-1 w-full bg-gray-100 rounded-xl">
            ...
            <div className="p-4 w-[100%] md:w-1/3">
              <div className="flex rounded-lg h-full p-8 flex-col">
                <div className="flex items-center mb-3">
                  ...
                  <h2 className="text-gray-100 text-lg title-font font-medium">
                    Bootstrap{" "}
                    <TbBrandBootstrap className="inline ml-2 bg-red-800" />
                  </h2>
                </div>
                <div className="flex-grow">
                  <div className="relative h-1 w-full bg-gray-100 rounded-xl">
            ...
            <div className="p-4 w-[100%] md:w-1/3">
              <div className="flex rounded-lg h-full p-8 flex-col">
                <div className="flex items-center mb-3">
                  ...
                  <h2 className="text-gray-100 text-lg title-font font-medium">
                    React/NextJs <FaReact className="inline ml-2" /> /{" "}
            ...
            <div className="p-4 w-[100%] md:w-1/3">
              <div className="flex rounded-lg h-full p-8 flex-col">
                <div className="flex items-center mb-3">
                  ...
                  <h2 className="text-gray-100 text-lg title-font font-medium">
                    Video Editing{" "}
                    <CiVideoOn className="inline ml-2 bg-blue-800 font-bold" />
                  </h2>
                </div>
                <div className="flex-grow">
                  <div className="relative h-1 w-full bg-gray-100 rounded-xl">
            ...
            <div className="p-4 w-[100%] md:w-1/3">
              <div className="flex rounded-lg h-full p-8 flex-col">
                <div className="flex items-center mb-3">
                  ...
                  <h2 className="text-gray-100 text-lg title-font font-medium">
                    Adobe Illustrator{" "}
                    <SiAdobeillustrator className="inline ml-2 bg-yellow-800" />
                  </h2>
                </div>
                <div className="flex-grow">
                  <div className="relative h-1 w-full bg-gray-100 rounded-xl">
            ...
            <div className="p-4 w-[100%] md:w-1/3">
              <div className="flex rounded-lg h-full p-8 flex-col">
                <div className="flex items-center mb-3">
                  ...
                  <h2 className="text-gray-100 text-lg title-font font-medium">
                    Adobe Photoshop{" "}
                    <SiAdobephotoshop className="inline ml-2 bg-blue-600" />
                  </h2>
                </div>
                <div className="flex-grow">
                  <div className="relative h-1 w-full bg-gray-100 rounded-xl">
