        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
            <div className="flex justify-end  h-[250px] w-50  mr-[60px] mx-10 md: mb-[200px] md:mr-15 lg:w-[400px] lg:mt-5">
              <img
                className="rounded-full w-[350px] h-[300px] mt-4  md:h-[400px] lg:w-[400px] lg:h-[400px] border-8 border-[#de7c3c] transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ... "
